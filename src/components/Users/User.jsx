...
export const User = ({ id, first_name, last_name, avatar, email, invitation}) => {

  const { onInvitation } = React.useContext(AppContext);
  ...
  return (
    <li>
      ...
      <img className="action"
        src={`/assets/${invitation ? 'minus' : 'plus'}.svg`}
        alt="Action"
        onClick={() => onInvitation(id)}
      />
    </li>
  )
};
